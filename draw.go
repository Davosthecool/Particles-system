...
func (g *game) Draw(screen *ebiten.Image) {
	...
	ebitenutil.DebugPrintAt(screen, fmt.Sprint("MaxScaleY : ",config.General.MaxScaleY),0,615)
		...
		ebitenutil.DebugPrintAt(screen,fmt.Sprint("Lorsque vous cliquez / maintenez le clic gauche, vous faites apparaitre ", config.General.ClickSpawnRate, " particules par clic"), 0, 20)
